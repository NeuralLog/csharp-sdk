...
This document describes the configuration options for NeuralLog Csharp.

## Configuration Options

The Csharp can be configured using the following options:
...
Csharp also supports configuration via environment variables:
...
You can also configure Csharp using a configuration file:
